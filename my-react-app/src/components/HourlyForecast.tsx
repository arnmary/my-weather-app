...
const HourlyForecast: React.FC<HourlyForecastProps> = ({ data }) => {
  return (
    <div className="bg-white bg-opacity-0 font-roboto  p-4 rounded-xl w-full overflow-x-auto whitespace-nowrap flex flex-col  gap-5">
      {data.map((hour, index) => (
        <div
          key={index}
          className="flex flex-row gap-5 justify-between items-start text-white mx-3  w-3/4"
        >
